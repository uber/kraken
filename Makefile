...
integration: $(LINUX_BINS) tools/bin/puller/puller docker_stop
	docker build -q -t kraken-agent:dev -f docker/agent/Dockerfile --build-arg USERID=$(USERID) --build-arg USERNAME=$(USERNAME) --build-arg HOMEDIR=$(HOMEDIR) ./
	docker build -q -t kraken-build-index:dev -f docker/build-index/Dockerfile --build-arg USERID=$(USERID) --build-arg USERNAME=$(USERNAME) --build-arg HOMEDIR=$(HOMEDIR) ./
	docker build -q -t kraken-origin:dev -f docker/origin/Dockerfile --build-arg USERID=$(USERID) --build-arg USERNAME=$(USERNAME) --build-arg HOMEDIR=$(HOMEDIR) ./
	docker build -q -t kraken-proxy:dev -f docker/proxy/Dockerfile --build-arg USERID=$(USERID) --build-arg USERNAME=$(USERNAME) --build-arg HOMEDIR=$(HOMEDIR) ./
	docker build -q -t kraken-testfs:dev -f docker/testfs/Dockerfile --build-arg USERID=$(USERID) --build-arg USERNAME=$(USERNAME) --build-arg HOMEDIR=$(HOMEDIR) ./
	docker build -q -t kraken-tracker:dev -f docker/tracker/Dockerfile --build-arg USERID=$(USERID) --build-arg USERNAME=$(USERNAME) --build-arg HOMEDIR=$(HOMEDIR) ./
