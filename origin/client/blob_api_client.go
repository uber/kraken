...
func NewBlobAPIClient(address string, blobStore *store.LocalStore) *BlobAPIClient {
...
func (cli *BlobAPIClient) verifyBlob(digest dockerimage.Digest, reader io.ReadCloser) (bool, error) {
	defer reader.Close()
...
func (cli *BlobAPIClient) PullBlob(digest dockerimage.Digest) error {
...
func (cli *BlobAPIClient) PushBlob(digest dockerimage.Digest) error {
...
func (cli *BlobAPIClient) CheckBlobExists(digest dockerimage.Digest) (bool, error) {
...
func (cli *BlobAPIClient) pushStart(digest dockerimage.Digest) (string, error) {
...
func (cli *BlobAPIClient) pushBlobContent(location string, digest dockerimage.Digest) error {
...
func (cli *BlobAPIClient) pushBlobChunk(location string, digest dockerimage.Digest, reader io.Reader, start, endIncluded int64) (string, error) {
