...
// Source: code.uber.internal/infra/kraken/origin/blobserver (interfaces: Client,ClientProvider,ClusterClientResolver)
...
// MockClusterClientResolver is a mock of ClusterClientResolver interface
type MockClusterClientResolver struct {
	ctrl     *gomock.Controller
	recorder *MockClusterClientResolverMockRecorder
}

// MockClusterClientResolverMockRecorder is the mock recorder for MockClusterClientResolver
type MockClusterClientResolverMockRecorder struct {
	mock *MockClusterClientResolver
}

// NewMockClusterClientResolver creates a new mock instance
func NewMockClusterClientResolver(ctrl *gomock.Controller) *MockClusterClientResolver {
	mock := &MockClusterClientResolver{ctrl: ctrl}
	mock.recorder = &MockClusterClientResolverMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockClusterClientResolver) EXPECT() *MockClusterClientResolverMockRecorder {
	return m.recorder
}

// Resolve mocks base method
func (m *MockClusterClientResolver) Resolve(arg0 image.Digest) ([]blobserver.Client, error) {
...
func (mr *MockClusterClientResolverMockRecorder) Resolve(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Resolve", reflect.TypeOf((*MockClusterClientResolver)(nil).Resolve), arg0)
}
