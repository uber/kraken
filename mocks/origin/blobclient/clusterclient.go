...
// DownloadBlobWithContext mocks base method.
func (m *MockClusterClient) DownloadBlobWithContext(arg0 context.Context, arg1 string, arg2 core.Digest, arg3 io.Writer) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DownloadBlobWithContext", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(error)
	return ret0
}

// DownloadBlobWithContext indicates an expected call of DownloadBlobWithContext.
func (mr *MockClusterClientMockRecorder) DownloadBlobWithContext(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DownloadBlobWithContext", reflect.TypeOf((*MockClusterClient)(nil).DownloadBlobWithContext), arg0, arg1, arg2, arg3)
}
...
// PrefetchBlobWithContext mocks base method.
func (m *MockClusterClient) PrefetchBlobWithContext(arg0 context.Context, arg1 string, arg2 core.Digest) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PrefetchBlobWithContext", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// PrefetchBlobWithContext indicates an expected call of PrefetchBlobWithContext.
func (mr *MockClusterClientMockRecorder) PrefetchBlobWithContext(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PrefetchBlobWithContext", reflect.TypeOf((*MockClusterClient)(nil).PrefetchBlobWithContext), arg0, arg1, arg2)
}
...
func (m *MockClusterClient) UploadBlob(arg0 string, arg1 core.Digest, arg2 io.ReadSeeker) error {
	m.ctrl.T.Helper()
